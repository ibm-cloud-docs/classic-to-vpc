...
You provision a new virtual server instance, and it shows as running, but you cannot connect to it over SSH.
{: shortdesc}
...
- A floating IP address not associated with the virtual server instance.
...
2. Associate a floating IP address with the virtual server instance when you use a public IP address. For more information, see [Creating network interfaces with floating IP addresses](/docs/vpc?topic=vpc-fip-working).
